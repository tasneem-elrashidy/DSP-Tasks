...
def QuantizationTest2(file_name,Your_IntervalIndices,Your_EncodedValues,Your_QuantizedValues,Your_SampledError):
    ...
    for i in range(len(Your_IntervalIndices)):
        if(Your_IntervalIndices[i]!=expectedIntervalIndices[i]):
            print(Your_IntervalIndices,expectedIntervalIndices)
...
intervals,quantized,encodedvalue,errorlist=signalOperations.oprations.levelquantization("Task3/Quan2_input.txt",4)    
QuantizationTest2("Task3/Quan2_Out.txt",intervals,encodedvalue,quantized,errorlist)
