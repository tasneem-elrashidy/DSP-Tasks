...
quantizedvalue,encodedvalue=signalOperations.oprations.bitquantization("Task3/Quan1_input.txt",3)    
QuantizationTest1("Task3/Quan1_Out.txt",encodedvalue,quantizedvalue)