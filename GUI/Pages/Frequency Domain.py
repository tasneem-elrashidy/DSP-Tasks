...
#             # st.snow()
#             if(choice=="DFT"):
#                 indx,originalsig,amp,phase=signalOperations.oprations.Fouriore("IDFT",file) #dft ver
#                 if new_amp and new_phase:
#                     amp,phase=functions.modifyAmpPhase(amp,phase,idx,new_amp,new_phase)
#             else:
#                 indx,originalsig,amp,phase=signalOperations.oprations.Fouriore("IDFT",file) #idft ver
